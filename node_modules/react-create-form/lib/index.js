(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactCreateForm"] = factory(require("react"), require("prop-types"));
	else
		root["ReactCreateForm"] = factory(root["react"], root["prop-types"]);
...
exports.rules = exports.errors = exports.default = undefined;

var _createForm = __webpack_require__(92);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _createForm.createForm;
  }
});
...
var _rules = __webpack_require__(98);
...
var _compareArrays = __webpack_require__(96);
...
var shouldUpdate = function shouldUpdate() {
  var nextFields = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var prevFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var state = arguments[2];

  var names = Object.keys(state);

  return Object.entries(nextFields).some(function (_ref) {
 ...
 * @returns {Array}
 */
var filterForm = function filterForm(state) {
  var blacklist = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  return Object.entries(state).filter(function (_ref3) {
 ...
 */
var createInitialState = function createInitialState(fields) {
  return Object.entries(fields).reduce(function (state, _ref5) {
    var _ref6 = _slicedToArray(_ref5, 2),
        ...
        label = _ref6$$label === undefined ? 'Field' : _ref6$$label,
        _ref6$$rules = _ref6$.rules,
        rules = _ref6$$rules === undefined ? [] : _ref6$$rules;

    return _extends({}, state, _defineProperty({}, name, { value: value, label: label, rules: rules, clean: !value.length }));
  }, {});
};
 ...
 * debugging.
 */
var getDisplayName = function getDisplayName(_ref7) {
  var displayName = _ref7.displayName,
      _ref7$name = _ref7.name,
      name = _ref7$name === undefined ? 'Component' : _ref7$name;
  return 'ReactCreateForm(' + (displayName || name) + ')';
};
 ...
 * @returns {Class}
 */
var createForm = function createForm(WrappedComponent, fields) {
  var _class, _temp;

  return _temp = _class = function (_Component) {
    _inherits(ReactCreateForm, _Component);

    function ReactCreateForm(props) {
      _classCallCheck(this, ReactCreateForm);

      var _this = _possibleConstructorReturn(this, (ReactCreateForm.__proto__ || Object.getPrototypeOf(ReactCreateForm)).call(this, props));

      _this.initialState = createInitialState(fields);
      _this.state = _this.initialState;
      _this.update = _this.update.bind(_this);
      _this.reset = _this.reset.bind(_this);
      _this.getFormDataAsJSON = _this.getFormDataAsJSON.bind(_this);
    ...
    _createClass(ReactCreateForm, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (!Object.keys(fields).length) {
          this.reset();
        } else if (shouldUpdate(fields, this.props.fields, this.state)) {
          this.update(fields);
        }
      }
      ...
      value: function update(fields) {
        ...
        this.setState(function (prevState) {
          return Object.entries(fields).reduce(function (fields, _ref8) {
            ...
            var field = prevState[name];
            var clean = field.clean && value === '';
            return _extends({}, fields, _defineProperty({}, name, _extends({}, field, { value: value, clean: clean })));
          }, {});
        });
      }
      ...
      key: 'getFormDataAsJSON',
      value: function getFormDataAsJSON(blacklist) {
        var fields = filterForm(this.state, blacklist);
        ...
        function nextField(fields, index, resolve) {
          var data = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

          if (index--) {
            var _fields$index = _slicedToArray(fields[index], 2),
                name = _fields$index[0],
                _fields$index$ = _fields$index[1],
                value = _fields$index$.value,
                files = _fields$index$.files;
            ...
            if (files) {
              ...
              var nextFile = readFiles(files, fileReader);
              var fileList = [];

              fileReader.addEventListener('load', function (event) {
                fileList = [].concat(_toConsumableArray(fileList), [event.currentTarget.result]);
      ...
      key: 'getFormData',
      value: function getFormData(blacklist) {
        var fields = filterForm(this.state, blacklist);
        var formData = new FormData();

        fields.forEach(function (_ref10) {
      ...
      value: function validate(form) {
        ...
        if (form.willSubmit) {
          ...
          var _fields = Object.entries(this.state);
          var clean = _fields.some(function (_ref12) {
          ...
          if (clean) {
            _fields.forEach(function (_ref14) {
              var _ref15 = _slicedToArray(_ref14, 2),
                  name = _ref15[0],
                  field = _ref15[1];

              if (field.clean) {
                _this2.setState(_defineProperty({}, name, _extends({}, field, { clean: false })));
              }
            });
          }
      ...
      value: function handleChange(event) {
        ...
        var field = _extends({}, this.state[name], { value: value, clean: false });

        if (type === 'select-multiple') {
          field = _extends({}, field, { value: [].concat(_toConsumableArray(target.selectedOptions)).map(function (option) {
              return option.value;
            }) });
        } else if (type === 'checkbox' && !target.checked) {
          field = _extends({}, field, { value: '' });
        } else if (type === 'file') {
          field = _extends({}, field, { files: target.files });
        }

        this.setState(_defineProperty({}, name, field));
      }
    }, {
      key: 'render',
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['fields']);

        var form = (0, _validator.validateForm)(this.state);
    ...
    return ReactCreateForm;
  }(_react.Component), _class.displayName = getDisplayName(WrappedComponent), _class.defaultProps = {
    id: null,
    fields: {}
  }, _class.propTypes = {
    id: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.number, _propTypes2.default.string]),
...
var validateField = function validateField(_ref, fields) {
  ...
  rules.forEach(function (validate) {
    var error = validate(value.toString().trim(), label, fields);
    if (error) errors = [].concat(_toConsumableArray(errors), [error]);
  });
 ...
 */
var getFields = function getFields(entries) {
  return entries.reduce(function (fields, _ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        name = _ref3[0],
        value = _ref3[1].value;

    return _extends({}, fields, _defineProperty({}, name, value));
  }, {});
};

var validateForm = exports.validateForm = function validateForm(state) {
  var form = {};
  var allErrors = [];
  var fieldValidity = [];
  var entries = Object.entries(state);
  var fields = getFields(entries);
  ...
  entries.forEach(function (_ref4) {
    ...
    var field = { value: value, errors: [], error: ''
      ...
      if (!clean) {
        var errors = validateField({ rules: rules, value: value, label: label }, fields);
        if (errors.length) {
          field = _extends({}, field, { errors: errors, error: errors[0] });
          allErrors = [].concat(_toConsumableArray(allErrors), [errors]);
        } else {
          isValid = true;
        }
      }

      fieldValidity = [].concat(_toConsumableArray(fieldValidity), [isValid]);
    }

    form = _extends({}, form, _defineProperty({}, name, field));
  });

  var willSubmit = !fieldValidity.some(function (isValid) {
    return isValid === false;
  });
  return _extends({}, form, { willSubmit: willSubmit, errors: allErrors });
};
...
var createError = function createError() {
  ...
  error = error.replace(/\$1/g, arg1).replace(/\$2/g, arg2).replace(/\$label/g, label).replace(/\$value/g, value).replace(/\\/g, '\\\\');

  return error ? eval('`' + error + '`') : 'Validation failed.';
};

var createRule = function createRule(validate) {
  return function () {
    ...
    return function (error) {
      return function (value, label, fields) {
        return validate(value, args, fields) ? '' : createError(error, args, label, value);
      };
    };
  };
};
...
var rules = exports.rules = {
  ...
  required: createRule(function (value) {
    return value.length > 0;
  }),
  length: createRule(function (value, _ref) {
    var _ref2 = _slicedToArray(_ref, 1),
        length = _ref2[0];

    return value.length === length;
  }),
  min: createRule(function (value, _ref3) {
    var _ref4 = _slicedToArray(_ref3, 1),
        length = _ref4[0];

    return value.length >= length;
  }),
  max: createRule(function (value, _ref5) {
  ...
  equals: createRule(function (value, _ref7) {
  ...
  starts: createRule(function (value, _ref9) {
  ...
  ends: createRule(function (value, _ref11) {
    ...
    var l = value.length;
    return list.some(function (item) {
      return value.indexOf(item, l - String(item).length) !== -1;
    });
  }),

  contains: createRule(function (value, _ref13) {
  ...
  number: createRule(function (value) {
    return (/^\d+$/.test(value)
    );
  }),

  range: createRule(function (value, _ref15) {
  ...
  between: createRule(function (value, _ref17) {
  ...
  matches: createRule(function (value, _ref19) {
  ...
  custom: function custom(validate) {
    return function (value, label, fields) {
      var error = validate(value, fields);
